      ...
      <div style={{
        ...
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '12px' }}>
            ...
            <span className="font-display" style={{ fontSize: '1.4rem', fontWeight: '900', color: '#ffffff' }}>
              StayPulse
            </span>
          </div>

          <p style={{ fontSize: '0.86rem', lineHeight: '1.6', color: 'var(--text-muted)' }}>
        ...
        <div>
          <h4 style={{ fontSize: '0.96rem', fontWeight: '800', color: '#ffffff', marginBottom: '14px' }}>
            系統核心服務
          </h4>
          <ul style={{ listStyle: 'none', padding: 0, fontSize: '0.86rem', display: 'flex', flexDirection: 'column', gap: '10px' }}>
            <li>
              <button onClick={onOpenLineBotModal} style={{ background: 'none', border: 'none', color: '#34d399', cursor: 'pointer', fontWeight: '700', padding: 0 }}>
                🤖 LINE 機器人關鍵字房價查詢
              </button>
            </li>
            <li>
              <button onClick={onOpenConsole} style={{ background: 'none', border: 'none', color: 'var(--text-muted)', cursor: 'pointer', padding: 0 }}>
                ⚡ Apify / RapidAPI 爬蟲實時控制台
              </button>
            </li>
            <li>
              <span style={{ color: 'var(--text-muted)' }}>👑 全網最低價比價與防禦自動校正</span>
            </li>
          </ul>
        </div>
